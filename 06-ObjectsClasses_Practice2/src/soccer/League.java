...
public class League {
    ...
    public static void main(String[] args) {
       ...
       goal1.theTime = 55;
        ...
        System.out.println("Goal scored by " + currGame.goals[0].theTeam.teamName + " at approx. " +currGame.goals[0].theTime+ " mins by player " +currGame.goals[0].thePlayer.playerName);
