...
public class League {
    ...
    public String getLeagueAnnouncement(Game[] theGames) {
        ...
        StringBuilder sb = new StringBuilder("The League is scheduled to run for ");
        sb.append(thePeriod.getMonths());
        sb.append(" month(s), and ");
        sb.append(thePeriod.getDays());
        sb.append(" day(s) \n");
                
        leagueDesc = sb.toString();
